...
volume_play_button.addEventListener('click', ()=> {
    ...
    // костыли...............
    if (volume_play_button.src.includes('icons/unmute-button.svg')) {
        miniVolumeBtn.src = 'icons/mute-button.svg'
    } else {
        miniVolumeBtn.src = 'icons/unmute-button.svg'
    }
})

const volumeButton = document.querySelectorAll('.volume_play_button')

volumeButton.forEach(item => {
    item.addEventListener('click', ()=> {
        if (item.src.includes('icons/unmute-button.svg')) {
            item.src = 'icons/mute-button.svg'
        } else {
            item.src = 'icons/unmute-button.svg'
        }
    })
})
